...
export default function BusinessInfoStep() {
  ...
  return (
    <StepShell title="Tell us about your business" description="This is what your AI receptionist will introduce itself with." onContinue={handleContinue} continueDisabled={!canContinue || saving} continueLabel={saving ? "Saving…" : "Continue"}>
      <div className="space-y-5">
        ...
        <div>
          ...
          <Input id="businessName" className="mt-1.5" placeholder="Riverside Auto & Tire" value={draft.businessName} onChange={(e) => update({ businessName: e.target.value })} />
        </div>
        <div>
        ...
        <div>
          ...
          <Textarea id="description" rows={3} className="mt-1.5" placeholder="A family-owned auto shop specializing in routine maintenance and brake work…" value={draft.description} onChange={(e) => update({ description: e.target.value })} />
        </div>
      </div>
    </StepShell>
  );
