...
const FEATURES = [
  {
    ...
    detail: "Picks up 24/7 and knows your business.",
  },
  {
    icon: CalendarClock,
    title: "Books real appointments",
    detail: "Checks your real calendar, only offers open times.",
  },
  {
    icon: Globe,
    title: "Learns your business in minutes",
    detail: "Paste your website — services and FAQs import automatically.",
  },
  {
    icon: ShieldCheck,
    title: "Knows when to hand off",
    detail: "Escalates refunds and complaints to you, handles the rest itself.",
  },
  {
    icon: MessageSquareText,
    title: "Texts a confirmation automatically",
    detail: "Every booking gets a real SMS, no extra step for you.",
  },
  {
    icon: Mic2,
    title: "Sounds like a real person",
    detail: "Natural voices, not a robotic phone tree.",
  },
];
...
const FAQS = [
  {
    ...
    a: "No — natural voices, not an old-school phone tree.",
  },
  {
    q: "What if it can't answer something?",
    a: "It hands off to you instead of guessing. It never invents prices or policies.",
  },
  {
    q: "Do I need a new phone number?",
    a: "No. Forward your existing number, or use a new one we provide.",
  },
  {
    q: "What happens after my free trial?",
    a: "You're billed automatically unless you cancel first. No surprise commitment.",
  },
  {
    q: "Can I control what it says?",
    a: "Yes — personality, voice, and rules are all yours to set. No prompt-writing needed.",
  },
];
...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-paper">
      ...
      <main>
        {/* ---------- Problem: real, sourced stat — tightened for mobile ---------- */}
        <section className="bg-ink py-14">
          <div className="mx-auto max-w-3xl px-6">
            ...
            <p className="mt-4 text-[11px] text-[#6B7488]">
              Source: 411 Locals, 85 businesses across 58 industries.
            </p>
          </div>
        </section>

        {/* ---------- Hero: headline + CTA, paired with before/after visual ---------- */}
          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            ...
            <div className="space-y-3">
              <div className="rounded-2xl border border-border bg-card p-4 opacity-80">
                <div className="text-[10.5px] font-semibold uppercase tracking-wide text-text-faint">
                  Without HavnLine
                </div>
        ...
        <section className="border-y border-border bg-card py-14">
          <div className="mx-auto max-w-4xl px-6 text-center">
            ...
            <h2 className="mt-2.5 font-display text-[22px] font-semibold text-ink">
              If you take appointments by phone, this is for you.
            </h2>
            <div className="mt-6 flex flex-wrap items-center justify-center gap-2.5">
              {INDUSTRIES.map((ind) => (
                <div
                  key={ind.label}
                  className="flex items-center gap-1.5 rounded-full border border-border bg-paper px-3.5 py-1.5 text-[12.5px] font-medium text-text"
                >
        ...
        <section className="mx-auto max-w-6xl px-6 py-14">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-2.5 font-display text-[26px] font-semibold leading-tight text-ink">
              A great front-desk hire — without the payroll.
            </h2>
          </div>
            ...
            <div className="mt-5 grid gap-3.5 sm:grid-cols-3">
              {STEPS.map((step, i) => (
                <div key={step.label} className="rounded-2xl border border-border bg-paper p-4">
                  <div className="flex h-7 w-7 items-center justify-center rounded-full bg-card font-mono text-[11.5px] font-medium text-text-muted">
                    {i + 1}
                  </div>
        ...
        {/* ---------- FAQ — clears doubts before the ask ---------- */}
        ...
        {/* ---------- Pricing — right before the final ask, once the case is made ---------- */}
        ...
        <section className="bg-ink py-14">
          <div className="mx-auto max-w-6xl px-6 text-center">
            <h2 className="font-display text-[26px] font-semibold text-white sm:text-[32px]">
              Stop losing customers to a phone that doesn&apos;t answer.
            </h2>
            <p className="mx-auto mt-2.5 max-w-md text-[13px] text-[#8A93A6]">
